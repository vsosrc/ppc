...
sed -i "s/SED_JAVA_HOME/$_JAVAHOME/g" /opt/vse/hadoop/etc/hadoop/*.sh
sed -i "s/SED_HADOOPTMPDIR_CORE/\/opt\/vse\/disk1\/app\/hadoop\/tmp/g" /opt/vse/hadoop/etc/hadoop/*.xml
sed -i "s/SED_FSDEFAULTFS_CORE/$_NNIPADDRESS/g" /opt/vse/hadoop/etc/hadoop/*.xml
...
sed -i "s/SED_RTRACKKERIPADDRESS_YARN/$_NNIPADDRESS/g" /opt/vse/hadoop/etc/hadoop/*.xml
sed -i "s/SED_SCHEDULERIPADDRESS_YARN/$_NNIPADDRESS/g" /opt/vse/hadoop/etc/hadoop/*.xml
sed -i "s/SED_RMIPADDRESS_YARN/$_NNIPADDRESS/g" /opt/vse/hadoop/etc/hadoop/*.xml
sed -i "s/SED_NMHOSTNAME_YARN/$_NNIPADDRESS/g" /opt/vse/hadoop/etc/hadoop/*.xml
sed -i "s/SED_NMIPADDRESS_YARN/$_NNIPADDRESS/g" /opt/vse/hadoop/etc/hadoop/*.xml
